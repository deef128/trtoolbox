...
Example scripts are provided for each module for a hands-on experience on how to use this toolbox. The :py:class:`trtoolbox.test.DataGenerator` module found in ./test can be used to generate some spectroscopic data which is helpful to train yourself in analyzing your data with this toolbox.
