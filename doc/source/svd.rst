...
It is advised to run the :py:meth:`trtoolbox.svd.show_svs` routine prior the reconstruction of the data. It will show abstract time traces, spectra and how much variance is explained by singular values. Careful inspection of this information shall help to decide how many singular values should be used for recontruction with the :py:meth:`trtoolbox.svd.dosvd` routine. *n* is here the number of singular values. It can also be a list of values.

The returned objext is :py:class:`trtoolbox.svd.Results`.
